(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["bullbetgold\\\\.in(?:/.*)?/ola/services/.*","bullbetgold\\\\.in/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://b680771b-76cf-486b-9b48-05b7ae4bc078\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["bullbetgold\\\\.in(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/b680771b-76cf-486b-9b48-05b7ae4bc078/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/b680771b-76cf-486b-9b48-05b7ae4bc078/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/"]').map((e => ({
                url: e,
                revision: "1729095695433"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("bullbetgold.in-"))).map((e => caches.delete(e))))
            })))
